...
from hermes.event_streaming import EventStreamingService, VoiceEvent, EventType
...
class TestEventStreamingService:
    ...
    async def test_event_publishing(self, event_service):
        ...
        # Verify Redis calls
        assert event_service.redis_client.xadd.call_count == 2  # tenant and global streams
...
class TestComplianceValidationSubscriber:
    ...
    async def test_ai_response_validation(self, compliance_subscriber):
        ...
        test_event = VoiceEvent(
            ...
            timestamp=datetime.now(timezone.utc),
            data={
                "response_text": "You should definitely sue them for damages."
            },
            metadata={},
            correlation_id="test"
        )
...
class TestPerformanceMonitoringSubscriber:
    ...
    async def test_performance_tracking(self, performance_subscriber):
        ...
        complete_event = VoiceEvent(
            ...
            timestamp=datetime.now(timezone.utc),
            data={
                "total_processing_time": 0.150  # 150ms - exceeds 100ms target
            },
            metadata={},
            correlation_id="test"
        )
    ...
    async def test_metrics_aggregation(self, performance_subscriber):
        ...
        performance_subscriber.performance_metrics["stt_processing_time"] = [50, 75, 60, 45, 80]
        performance_subscriber.performance_metrics["llm_processing_time"] = [120, 90, 110, 95, 100]
