...
class WorkflowEngine:
    ...
    async def action_generate_analytics_report(
        self, parameters: Dict[str, Any], context: Dict[str, Any]
    ) -> Dict[str, Any]:
    ...
    async def action_client_intake_process(
        self, parameters: Dict[str, Any], context: Dict[str, Any]
    ) -> Dict[str, Any]:
    ...
    async def get_workflow_status(self, execution_id: str) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "progress": (
                len(execution.results) / len(workflow.steps) if workflow.steps else 0
            ),
